...
public class HoSoDienTu : AuditableEntity, IAggregateRoot
{
    ...
    public HoSoDienTu(string IDCongDan, string TaiKhoanTao, string TenHoSo, string MaHoSo, string? TenThuTuc, string? MaThuTuc, string? TenNhomHoSo, string? MaNhomHoSo, string? TenLoaiHoSo, string? MaLoaiHoSo)
    {
    ...
    public HoSoDienTu Update(string? iDCongDan, string? taiKhoanTao,string? maHoSo, string? tenHoSo, string? maThuTuc, string? tenThuTuc, string? tenNhomHoSo, string? maNhomHoSo, string? tenLoaiHoSo, string? maLoaiHoSo)
    {
