...
public class CreateHoSoDienTuRequestHandler : IRequestHandler<CreateHoSoDienTuRequest, Result<Guid>>
{
    ...
    {
        var item = new HoSoDienTu(request.IDCongDan, request.TaiKhoanTao, request.TenHoSo, request.MaHoSo, request.TenThuTuc, request.MaThuTuc, request.TenNhomHoSo, request.MaNhomHoSo, request.TenLoaiHoSo, request.MaLoaiHoSo);
