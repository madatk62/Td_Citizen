...
public class CompaniesAllBySearchRequestSpec : EntitiesByBaseFilterSpec<Company, CompanyExportDto>
{
    public CompaniesAllBySearchRequestSpec(ExportCompaniesRequest request)
        : base(request) =>
        Query
